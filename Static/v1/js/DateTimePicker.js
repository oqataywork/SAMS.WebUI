...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		shortDayNames: ["Bazar", "Bazar ertəsi", "Çərşənbə axşamı", "Çərşənbə", "Cümə axşamı", "Cümə", "Şənbə"],
		fullDayNames: ["Bazar", "Bazar ertəsi", "Çərşənbə axşamı", "Çərşənbə", "Cümə axşamı", "Cümə", "Şənbə"],
		shortMonthNames: ["Yan", "Fev", "Mart", "Apr", "May", "İyun", "İyul", "Avq", "Sen", "Okt", "Noy", "Dek"],
		fullMonthNames: ["Yanvar", "Fevral", "Mart", "Aprel", "May", "İyun", "İyul", "Avqust", "Sentyabr", "Oktyabr", "Noyabr", "Dekabr"],
		...
		showHeader: true,
		titleContentDate: "Seçin",
		titleContentTime: "Set Time",
		titleContentDateTime: "Set Date & Time",

		buttonsToDisplay: ["HeaderCloseButton", "SetButton", "ClearButton"],
		setButtonContent: "Əlavə et",
		clearButtonContent: "Təmizlə",
...
(function (factory) {
	...
	DateTimePicker.prototype = {
		...
		_createPicker: function () {
			...
			sTempStr += "<div class='mDateTimePickerHeader'>";
		...
		_clearButtonAction: function () {
			var oDTP = this;
			if (oDTP.oData.oInputElement !== null) {
				if (oDTP.settings.mode == "time") {
					oDTP._setValueOfElement("09:00");
				}
				else {
		...
		_modifyPicker: function () {
			...
			for (iTempIndex = 0; iTempIndex < oDTP.settings.buttonsToDisplay.length; iTempIndex++) {
				if ($.cf._compare(oDTP.settings.buttonsToDisplay[iTempIndex], "HeaderCloseButton"))
					bDisplayHeaderCloseButton = false; //default true
			...
			if (bDisplaySetButton)
				sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonSet mBtn mBtn-sec'>" + oDTP.settings.setButtonContent + "</a>";
			if (bDisplayClearButton)
				sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonClear mBtn mBtn-pr'>" + oDTP.settings.clearButtonContent + "</a>";
