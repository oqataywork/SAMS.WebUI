...
[Attributes.IsAuthenticated(Order = 0), Attributes.AuthorizeUserType(Order = 1)]
	public partial class AssetCategoryCharacteristicsMapsController : BaseController
	{
        ...
        [AccessLevelFilter(Action = AccessLevelEnum.Read, TableName = "tbl_AssetCategoryCharacteristicsMaps")]
        public async Task<ActionResult> AssetCategoryCharacteristicsMaps_Read([DataSourceRequest] DataSourceRequest request)
        {
            try
            {
        ...
        public AssetCategoryCharacteristicsMapModel GetAssetCategoryCharacteristicsMapByID(Guid id )
        {
            AssetCategoryCharacteristicsMapModel mod = null;
            try
            {
               mod = AssetCategoryCharacteristicsMapsService.OneAssetCategoryCharacteristicsMap(id);
            }
            catch (Exception ex)
            {
                Console.WriteLine(ex.Message);
        ...
        public ActionResult GetAssetCategoryCharacteristicsMapReadForm( string id)
        {

            try
            {
                AssetCategoryCharacteristicsMapModel mod = GetAssetCategoryCharacteristicsMapByID(new Guid(id));
                if(mod!=null)
                {
                    ViewBag.AssetCategoryCharacteristicID = mod.AssetCategoryCharacteristicID;
                    return PartialView("AssetCategoryCharacteristicsMapReadFormPartial", mod);
                }
        ...
        public ActionResult GetAssetCategoryCharacteristicsMapEditForm(string id)
        {
            ...
            try
            {
                ...
                {
                    ViewBag.AssetCategoryCharacteristicID = mod.AssetCategoryCharacteristicID;
                    return PartialView("AssetCategoryCharacteristicsMapEditFormPartial", mod);
                }
                return Json(null, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
        ...
        public ActionResult GetAssetCategoryCharacteristicsMapNewForm()
        {

            try
            {
                AssetCategoryCharacteristicsMapModel mod = new AssetCategoryCharacteristicsMapModel();
                if (mod != null)
                {
                    ViewBag.AssetCategoryCharacteristicID = mod.AssetCategoryCharacteristicID;
                    return PartialView("AssetCategoryCharacteristicsMapEditFormPartial", mod);
        ...
        public async Task<ActionResult> AssetCategoryCharacteristicsMaps_Create([DataSourceRequest] DataSourceRequest request, AssetCategoryCharacteristicsMapModel mod)
        {
            string _err = "";
            try
            {
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        [AccessLevelFilter(Action = AccessLevelEnum.Edit, TableName = "tbl_AssetCategoryCharacteristicsMaps")]
        public async Task<ActionResult> AssetCategoryCharacteristicsMaps_Create_or_Update([DataSourceRequest] DataSourceRequest request, AssetCategoryCharacteristicsMapModel mod)
        {
            try
            {
                string _err = "";
                ...
                if (mod != null)
                {
                    ...
                    {
                        ObjectResponse resp;
                        if (mod.AssetCategoryCharacteristicID==Guid.Empty)
                            resp = await AssetCategoryCharacteristicsMapsService.CreateAssetCategoryCharacteristicsMap(mod);      
                        else
                            resp = await AssetCategoryCharacteristicsMapsService.UpdateAssetCategoryCharacteristicsMap(mod);
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        [AccessLevelFilter(Action = AccessLevelEnum.Delete, TableName = "tbl_AssetCategoryCharacteristicsMaps")]
        public async Task<ActionResult> AssetCategoryCharacteristicsMaps_Destroy([DataSourceRequest] DataSourceRequest request, AssetCategoryCharacteristicsMapModel mod)
        {
            try
            {
                string _err = "";
                
                ObjectResponse resp = await AssetCategoryCharacteristicsMapsService.RemoveAssetCategoryCharacteristicsMap(mod.AssetCategoryCharacteristicID);
